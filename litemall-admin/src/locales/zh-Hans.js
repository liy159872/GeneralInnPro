...
export default {
  ...
  app: {
    menu: {
      ...
      stat_goods: '商品统计',
      external_link: '外链',
      external_link_tencent_cos: '小说散文',
      external_link_tencent_sms: '翎傑皓信',
      external_link_weixin_pay: '作者CSDN博客',
      external_link_weixin_mpkf: '作者小栈',
      external_link_alibaba_oss: 'Gitee',
      external_link_qiniu_kodo: '将军小栈移动端',
