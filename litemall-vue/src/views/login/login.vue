<template>
	<div class="login">
		...
		<div class="store_name">GeneralInnPro~</div>
	</div>
    ...
    <md-field-group>
      <md-field
        v-model="account"
        icon="username"
        placeholder="GeneralInnPro账号/邮箱/手机号"
      ...
      <div class="clearfix">
        <div class="float-l">
          <router-link to="/login/registerGetCode">立即注册</router-link>
        </div>
        <div class="float-r">
    ...
    <div align="center">
      <img  width="75%"  src="https://cdn.jsdelivr.net/gh/LJHX5470/LYiImageBed@main//LJHX/032.png" /><br>
    </div>


      <div class="text-desc text-center bottom_positon">@GeneralInnPro 将军小栈 李一 AND You</div>
