  ...
  <div class="about">
    ...
    <div class="author-info">
      <div class="author-avatar">
        <img src="https://cdn.jsdelivr.net/gh/LJHX5470/LYiImageBed@main//LJHX/055.png" alt="开发作者">
      </div>
    ...
    <div class="gf-info">
      <div class="gf-avatar">
        <img src="https://cdn.jsdelivr.net/gh/LJHX5470/LYiImageBed@main//LJHX/056.jpg" alt="女友支持">
      </div>
      <div class="gf-desc">
        <h3>女友支持</h3>
...
export default {
  data() {
    return {
      ...
      playHeight: 0,
      videoUrl: require("../assets/video/zxmwife.mp4"),
    };
  },
  methods: {
    handleBack() {
