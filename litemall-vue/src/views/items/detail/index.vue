<template>
  ...
  <div class="item_cell_group">
    ...
    <van-goods-action>
      <van-goods-action-icon @click="toCart" icon="https://cdn.jsdelivr.net/gh/LJHX5470/LYiImageBed@main//LJHX/gwcq.png" :info="(cartInfo > 0) ? cartInfo : ''"/>
      <van-goods-action-icon @click="addCollect" icon="https://cdn.jsdelivr.net/gh/LJHX5470/LYiImageBed@main//LJHX/sc.png" :style="(goods.userHasCollect !== 0) ? 'color: #f7b444;':''"/>
