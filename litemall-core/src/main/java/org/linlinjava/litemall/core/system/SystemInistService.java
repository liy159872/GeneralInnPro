...
class SystemInistService {
    ...
    static {
        ...
        // 商城相关配置默认值
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_NAME, "GeneralInnPro");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_ADDRESS, "深圳");
        ...
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_PHONE, "14736856351");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_QQ, "2080863176");
    }
